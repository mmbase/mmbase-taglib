...
<p class="link">
  ...
  |
  <a href="<mm:url page="listnodes.jsp" />">listnodes</a>
  |
  <a href="<mm:url page="relatednodes.jsp" />">relatednodes</a>
  |
  <a href="<mm:url page="list.jsp" />">list</a>
  |
  <a href="<mm:url page="related.jsp" />" >related</a>
  |
  ...
  |
  <a href="<mm:url page="create.jsp" />" >create</a>
  |
