 ...
 * @since  MMBase-1.6
 * @version $Id: DateHandler.java,v 1.6 2003-08-01 14:13:23 michiel Exp $
 */
public class DateHandler extends AbstractTypeHandler {
    ...
    public String useHtmlInput(Node node, Field field) throws JspTagException {
        ...
        Calendar cal = Calendar.getInstance();
        try {
            Integer day    = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_day"), false));
            Integer month  = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_month"), false));
            Integer year   = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_year"), false));
            Integer hour   = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_hour"), false));
            Integer minute = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_minute"), false));
            Integer second = new Integer(context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_second"), false));
    ...
    public String whereHtmlInput(Field field) throws JspTagException {
        ...
        String fieldName = field.getName();
        Calendar cal = Calendar.getInstance();
        String input_day    = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_day"), false);
        String input_month  = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_month"), false);
        String input_year   = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_year"), false);
        String input_hour   = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_hour"), false);
        String input_minute = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_minute"), false);
        String input_second = context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName + "_second"), false);
        ...
        // check if changed:
        if (! context.getContextProvider().getContainer().findAndRegisterString(context.getPageContext(), prefix(fieldName), false).equals("" + cal.getTime().getTime() / DATE_FACTOR)) {
