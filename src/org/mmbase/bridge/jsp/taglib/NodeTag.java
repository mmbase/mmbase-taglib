 ...
 */
public class NodeTag extends NodeLikeTag implements BodyTag {
    ...
    */
    ...
    public int doStartTag() throws JspException{            
        ...
        if (number != null) { 
        ...
        } else { // get the node from a parent element.
            ...
            // node = nodeLike.getExportedNode();
            throw new JspException("Cannot find Node ");
        }
